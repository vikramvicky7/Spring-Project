...
<body class="bg-img">
	<form action="/app/updatePost" method="post">
		<div class="container" style="background-color: #2e2a2a7c;">
			...
			<h1 style="color: white;">Update post here</h1>

			<br>

			<form action="HomeController">
				<input type="text" class="form-control" name="pid"
					placeholder="Enter id"><br> <input type="text"
					class="form-control" name="title" placeholder="Enter title"><br>
				<input type="text" class="form-control" name="body"
					placeholder="Enter body"><br>
				<button type="submit" class="btn delete" name="buttonName"
					value="delete">Update</button>
