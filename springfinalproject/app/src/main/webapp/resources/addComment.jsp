...
<body class="bg-img">
	<form action="/app/addComment" method="post">
		...
		<div class="container" style="background-color: #2e2a2a7c;">
			...
			<h1 style="color: white;">Add Comment here</h1>

			<br>

			<form action="ControllerServlet">
				<input type="text" class="form-control" name="cbody"
					placeholder="Enter comment"><br> <input type="text"
					class="form-control" name="uid" placeholder="Enter uid"><br>
				<input type="text" class="form-control" name="pid"
					placeholder="Enter pid"><br>
				<button type="submit" class="btn delete" name="buttonName"
					value="delete">Add</button>
